...
#include "../../base.h"
  ...
  NexText LedStatus     = NexText       (2,   23, "t0");
  NexText LedCoord1     = NexText       (2,   24, "t1");
  NexText Hotend0       = NexText       (2,   25, "t2");
  NexText Hotend1       = NexText       (2,   29, "t3");
  NexText Hotend2       = NexText       (2,   26, "t4");
  NexText Fanspeed      = NexText       (2,   27, "t5");
  NexWaveform Wavetemp  = NexWaveform   (2,   30, "s0");
  NexProgressBar sdbar  = NexProgressBar(2,   28, "j0");
  ...
  NexPicture ScrollUp   = NexPicture    (3,   17, "p7");
  NexPicture ScrollDown = NexPicture    (3,   18, "p8");
  NexPicture sd_mount   = NexPicture    (3,   20, "p12");
  NexPicture sd_dismount= NexPicture    (3,   21, "p13");
  ...
  NexPicture tup        = NexPicture    (10,  5,  "p8");
  NexPicture tdown      = NexPicture    (10,  6,  "p9");
