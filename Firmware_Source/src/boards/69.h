...
#define BOARD_NAME "Anet v1.0"
  ...
  #error Oops!  Make sure you have 'Anet v1.0' selected from the 'Tools -> Boards' menu. 
  #endif
  ...
  #if MB(AZTEEG_X1) || MB(STB_11) || MB(ANET_V_10)
  ...
  //#define SDSS               24
    ...
    //LCD Pins
      ...
      #if ENABLED(U8GLIB_ST7920) //SPI GLCD 12864 ST7920 ( like [www.digole.com] ) For ANET_V_10 V2.0
        #if MB(ANET_V_10) // ANET_V_10 board
          #define LCD_PINS_RS     30 //CS chip select /SS chip slave select
          #define LCD_PINS_ENABLE 29 //SID (MOSI)
          #define LCD_PINS_D4     17 //SCK (CLK) clock
          #define ORIG_BEEPER_PIN 27 // Pin 27 is taken by LED_PIN, but ANET_V_10 LED does nothing with Marlin so this can be used for ORIG_BEEPER_PIN. You can use this pin with M42 instead of ORIG_BEEPER_PIN.
    ...
    #define BTN_EN2               10
      ...
      #if MB(ANET_V_10)
        #define BTN_ENC           29
        #define LCD_SDSS          30 // Panelolu2 SD card reader rather than the ANET_V_10
      #else
        #define BTN_ENC           30
      #endif
    #else
      #define BTN_ENC             16
      #define LCD_SDSS            28 // Smart Controller SD card reader rather than the ANET_V_10
    #endif //Panelolu2
